...
Within the 'Gift Card' domain, the `GiftCard` aggregate root was defined in [this](aggregate.md#basic-aggregate-structure) section. Let's leverage this domain to introduce entities:
