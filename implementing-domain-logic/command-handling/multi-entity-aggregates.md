...
Entities are, just like the aggregate root, simple objects, as is shown with the new `GiftCardTransaction` entity.
...
When using event sourcing as the mechanism to store the aggregates,
