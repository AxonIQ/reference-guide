...
To recap the definition as we have seen in the [clustering](clustering.md) section, contexts allow for strong separation of data without requiring deploying and managing full instances.
