...
[External Command Handlers](command-handlers/external-command-handler.md) however do require direct registration as being a command handler, which is shown in the following sample:
