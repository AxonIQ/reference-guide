...
Lastly, the `Serializer` used by the converter can be adjusted. See the [Serializer](../axon-application-development/event-handling/serializers.md) section for more details on this.
