...
The `EventHandlingConfiguration` bean, available in the Application Context, has methods to tweak the configuration of the Event Handlers. See [Configuration API](../part-ii-concepts/configuration-api.md) for details on configuring Event Handlers and Event Processors.
